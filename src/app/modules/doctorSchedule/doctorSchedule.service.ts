...
export const DoctorScheduleServices = {
  ...
  getMySchedule: async (filters: any, options: IOptions, user: IJWTPayload) => {
  ...
  getAllDoctorSchedule: async (filters: any, options: IOptions) => {
    const { limit, page, skip } = paginationHelper.calculatePagination(options);
  ...
  deleteSchedule: async (user: IJWTPayload, scheduleId: string) => {
    const doctorData = await prisma.doctor.findUniqueOrThrow({
      where: {
        email: user?.email,
      },
