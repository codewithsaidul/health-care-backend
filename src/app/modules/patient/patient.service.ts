...
export const PatientServices = {
  getAllPatient: async (filters: IPatientFilterRequest, options: IOptions) => {
  ...
  softDelete: async (id: string): Promise<Patient | null> => {
  ...
  updatePatient: async (user: IJWTPayload, payload: any) => {
